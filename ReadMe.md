...
'useRouteMatch' is  used so you can get access to it's match data.

2. How would you explain form validation to someone who has never programmed before?

Form Validation is the process of checking that the values in your form's input fields conform to certain expectations.

3. In 1-2 sentences, define end to end testing. 

End to end testing helps to check that individual unit of code (mostly functions) work as expected.
